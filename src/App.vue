				...
				<v-spacer></v-spacer>
					<v-container align="center" justify="center">
						<v-row justify="center">
							...
							<a @click="updateLang('en')" v-if="is_lang_french" class="pa-2 text-decoration-none navbar-image-link" target="_blank" ><v-img height="40" width="40" src="./assets/united-kingdom.svg"></v-img></a>
							<a @click="updateLang('fr')" v-else class="pa-2 text-decoration-none navbar-image-link" target="_blank" ><v-img height="40" width="40" src="./assets/france.svg"></v-img></a>
						</v-row>
					</v-container>
			</v-list>
		</v-navigation-drawer>
